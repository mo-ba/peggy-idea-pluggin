...
public class PeggyLabelIdentifierImpl extends ASTWrapperPsiElement implements PeggyLabelIdentifier {

  public PeggyLabelIdentifierImpl(@NotNull ASTNode node) {
    super(node);
  }
