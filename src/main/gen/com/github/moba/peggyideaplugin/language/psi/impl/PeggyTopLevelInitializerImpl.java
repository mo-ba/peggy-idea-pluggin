...
public class PeggyTopLevelInitializerImpl extends ASTWrapperPsiElement implements PeggyTopLevelInitializer {

  public PeggyTopLevelInitializerImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PeggyVisitor visitor) {
    visitor.visitTopLevelInitializer(this);
  }
