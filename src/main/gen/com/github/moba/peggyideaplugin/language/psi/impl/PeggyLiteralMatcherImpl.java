...
public class PeggyLiteralMatcherImpl extends ASTWrapperPsiElement implements PeggyLiteralMatcher {

  public PeggyLiteralMatcherImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PeggyVisitor visitor) {
    visitor.visitLiteralMatcher(this);
  }
