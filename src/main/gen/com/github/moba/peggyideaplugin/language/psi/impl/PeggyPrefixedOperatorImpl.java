...
public class PeggyPrefixedOperatorImpl extends ASTWrapperPsiElement implements PeggyPrefixedOperator {

  public PeggyPrefixedOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PeggyVisitor visitor) {
    visitor.visitPrefixedOperator(this);
  }
