...
public class PeggySemanticPredicateOperatorImpl extends ASTWrapperPsiElement implements PeggySemanticPredicateOperator {

  public PeggySemanticPredicateOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PeggyVisitor visitor) {
    visitor.visitSemanticPredicateOperator(this);
  }
